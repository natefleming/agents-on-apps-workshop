...
1. Starts the MLflow AgentServer backend
2. Clones and builds the Databricks chat UI (first run only)
3. Starts the Next.js frontend
4. Reports ready when both are running
"""
            ...
            for line in iter(process.stdout.readline, ""):
                ...
                if not is_ready and any(re.search(p, line, re.IGNORECASE) for p in patterns):
                    ...
                    if self.backend_ready and self.frontend_ready:
                        ...
                        print("  Open the chat UI at http://localhost:8000")
                        print("=" * 50 + "\n")
